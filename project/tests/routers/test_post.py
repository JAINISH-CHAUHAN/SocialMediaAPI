...
async def created_post(async_client:AsyncClient):
    return await create_post("Test body", async_client)
...
async def test_create_post_without_body(async_client: AsyncClient):
    response = await async_client.post("/post", json={"body": None})
...
@pytest.mark.anyio
async def test_create_empty_comment(async_client: AsyncClient, created_post: dict):
    body = None
